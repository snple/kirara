...
import (
	...
	"github.com/snple/kirara/bin/core/config"
	"github.com/snple/kirara/bin/core/log"
	"github.com/snple/kirara/core"
	"github.com/snple/kirara/db"
	"github.com/snple/kirara/http"
	"github.com/snple/kirara/http/core/api"
	"github.com/snple/kirara/http/core/web"
	"github.com/snple/kirara/node"
...
func main() {
	if len(os.Args) >= 2 {
		switch os.Args[1] {
		case "version", "-V":
			fmt.Printf("navia core version: %v\n", kirara.Version)
			return
		}
	}
