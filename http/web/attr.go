...
func (s *AttrService) list(ctx *gin.Context) {
	...
	reply, err := s.ws.Edge().GetAttr().List(context.Background(), request)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
...
func (s *AttrService) get(ctx *gin.Context) {
	...
	reply, err := s.ws.Edge().GetAttr().View(context.Background(), request)
	if err != nil {
...
func (s *AttrService) post(ctx *gin.Context) {
	...
	reply, err := s.ws.Edge().GetAttr().Create(context.Background(), &params)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
...
func (s *AttrService) patch(ctx *gin.Context) {
	...
	reply2, err := s.ws.Edge().GetAttr().Update(context.Background(), reply)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
...
func (s *AttrService) delete(ctx *gin.Context) {
	...
	_, err := s.ws.Edge().GetAttr().Delete(context.Background(), request)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
...
func (s *AttrService) status(ctx *gin.Context) {
	...
	reply, err := s.ws.Edge().GetAttr().View(ctx, request)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
	...
	reply2, err := s.ws.Edge().GetAttr().Update(ctx, reply)
	if err != nil {
		ctx.JSON(util.Error(400, err.Error()))
		return
	}
