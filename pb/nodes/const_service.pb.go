...
var file_nodes_const_service_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x61, 0x72, 0x61, 0x2f, 0x70, 0x62, 0x2f, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x3b, 0x6e,
...
var file_nodes_const_service_proto_goTypes = []interface{}{
...
func file_nodes_const_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_nodes_const_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nodes_const_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nodes_const_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_nodes_const_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
