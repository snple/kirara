...
var file_slots_slot_service_proto_goTypes = []interface{}{
...
func file_slots_slot_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_slots_slot_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginSlotRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_slots_slot_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoginSlotReply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_slots_slot_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
