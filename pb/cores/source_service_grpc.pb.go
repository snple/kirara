...
const (
	...
	SourceService_Name_FullMethodName            = "/cores.SourceService/Name"
	SourceService_NameFull_FullMethodName        = "/cores.SourceService/NameFull"
...
type SourceServiceClient interface {
	...
	Name(ctx context.Context, in *SourceNameRequest, opts ...grpc.CallOption) (*pb.Source, error)
	NameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Source, error)
...
func (c *sourceServiceClient) Name(ctx context.Context, in *SourceNameRequest, opts ...grpc.CallOption) (*pb.Source, error) {
	out := new(pb.Source)
...
func (c *sourceServiceClient) NameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Source, error) {
	out := new(pb.Source)
	err := c.cc.Invoke(ctx, SourceService_NameFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SourceServiceServer interface {
	...
	Name(context.Context, *SourceNameRequest) (*pb.Source, error)
	NameFull(context.Context, *pb.Name) (*pb.Source, error)
...
func (UnimplementedSourceServiceServer) Name(context.Context, *SourceNameRequest) (*pb.Source, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Name not implemented")
}
func (UnimplementedSourceServiceServer) NameFull(context.Context, *pb.Name) (*pb.Source, error) {
...
func _SourceService_Name_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SourceServiceServer).Name(ctx, req.(*SourceNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SourceService_NameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.Name)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SourceServiceServer).NameFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SourceService_NameFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SourceServiceServer).NameFull(ctx, req.(*pb.Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SourceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NameFull",
			Handler:    _SourceService_NameFull_Handler,
		},
		{
			MethodName: "Delete",
...
const (
	...
	TagService_Name_FullMethodName                = "/cores.TagService/Name"
	TagService_NameFull_FullMethodName            = "/cores.TagService/NameFull"
	...
	TagService_SetValueForce_FullMethodName       = "/cores.TagService/SetValueForce"
	...
	TagService_SetValueByNameForce_FullMethodName = "/cores.TagService/SetValueByNameForce"
...
type TagServiceClient interface {
	...
	Name(ctx context.Context, in *TagNameRequest, opts ...grpc.CallOption) (*pb.Tag, error)
	NameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Tag, error)
	Delete(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (*pb.MyBool, error)
	...
	GetValueByName(ctx context.Context, in *TagGetValueByNameRequest, opts ...grpc.CallOption) (*TagNameValue, error)
	SetValueByName(ctx context.Context, in *TagNameValue, opts ...grpc.CallOption) (*pb.MyBool, error)
	SetValueByNameForce(ctx context.Context, in *TagNameValue, opts ...grpc.CallOption) (*pb.MyBool, error)
...
func (c *tagServiceClient) Name(ctx context.Context, in *TagNameRequest, opts ...grpc.CallOption) (*pb.Tag, error) {
	out := new(pb.Tag)
...
func (c *tagServiceClient) NameFull(ctx context.Context, in *pb.Name, opts ...grpc.CallOption) (*pb.Tag, error) {
	out := new(pb.Tag)
	err := c.cc.Invoke(ctx, TagService_NameFull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tagServiceClient) GetValueByName(ctx context.Context, in *TagGetValueByNameRequest, opts ...grpc.CallOption) (*TagNameValue, error) {
...
func (c *tagServiceClient) SetValueByNameForce(ctx context.Context, in *TagNameValue, opts ...grpc.CallOption) (*pb.MyBool, error) {
	out := new(pb.MyBool)
...
type TagServiceServer interface {
	...
	Name(context.Context, *TagNameRequest) (*pb.Tag, error)
	NameFull(context.Context, *pb.Name) (*pb.Tag, error)
	Delete(context.Context, *pb.Id) (*pb.MyBool, error)
	...
	GetValueByName(context.Context, *TagGetValueByNameRequest) (*TagNameValue, error)
	SetValueByName(context.Context, *TagNameValue) (*pb.MyBool, error)
	SetValueByNameForce(context.Context, *TagNameValue) (*pb.MyBool, error)
...
func (UnimplementedTagServiceServer) Name(context.Context, *TagNameRequest) (*pb.Tag, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Name not implemented")
}
func (UnimplementedTagServiceServer) NameFull(context.Context, *pb.Name) (*pb.Tag, error) {
	return nil, status.Errorf(codes.Unimplemented, "method NameFull not implemented")
}
...
func (UnimplementedTagServiceServer) GetValueByName(context.Context, *TagGetValueByNameRequest) (*TagNameValue, error) {
...
func (UnimplementedTagServiceServer) SetValueByNameForce(context.Context, *TagNameValue) (*pb.MyBool, error) {
...
func _TagService_Name_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).Name(ctx, req.(*TagNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TagService_NameFull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(pb.Name)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagServiceServer).NameFull(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TagService_NameFull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).NameFull(ctx, req.(*pb.Name))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TagService_GetValueByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TagGetValueByNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).GetValueByName(ctx, req.(*TagGetValueByNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TagService_SetValueByNameForce_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).SetValueByNameForce(ctx, req.(*TagNameValue))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TagService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NameFull",
			Handler:    _TagService_NameFull_Handler,
		},
		{
			MethodName: "Delete",
