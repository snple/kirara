...
type SyncServiceClient interface {
	...
	WaitDeviceUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitDeviceUpdatedClient, error)
	...
	WaitTagValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitTagValueUpdatedClient, error)
}
...
func (c *syncServiceClient) WaitDeviceUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitDeviceUpdatedClient, error) {
...
func (c *syncServiceClient) WaitTagValueUpdated(ctx context.Context, in *pb.Id, opts ...grpc.CallOption) (SyncService_WaitTagValueUpdatedClient, error) {
...
type SyncServiceServer interface {
	...
	WaitDeviceUpdated(*pb.Id, SyncService_WaitDeviceUpdatedServer) error
	SetTagValueUpdated(context.Context, *SyncUpdated) (*pb.MyBool, error)
	GetTagValueUpdated(context.Context, *pb.Id) (*SyncUpdated, error)
	WaitTagValueUpdated(*pb.Id, SyncService_WaitTagValueUpdatedServer) error
...
func (UnimplementedSyncServiceServer) WaitDeviceUpdated(*pb.Id, SyncService_WaitDeviceUpdatedServer) error {
...
func (UnimplementedSyncServiceServer) WaitTagValueUpdated(*pb.Id, SyncService_WaitTagValueUpdatedServer) error {
